        ...
        <table class="form">
          ...
          <tr>
            ...
            <td><select name="position">
                <option value="top" <?php echo $selected_top;?>><?php echo $text_top;?></option>
                <option value="right" <?php echo $selected_right;?>><?php echo $text_right;?></option>
                <option value="bottom" <?php echo $selected_bottom;?>><?php echo $text_bottom;?></option>
                <option value="left" <?php echo $selected_left;?>><?php echo $text_left;?></option>
              </select></td>
          </tr>
        </table>
