          ...
          <tbody>
            ...
            <tr>
              <td style="text-align: center;"><?php if ($service['selected']) { ?>
                <input type="checkbox" name="selected[]" value="<?php echo $service['service_detail_id']; ?>" checked="checked" />
                <?php } else { ?>
                <input type="checkbox" name="selected[]" value="<?php echo $service['service_detail_id']; ?>" />
                <?php } ?></td>
