<?php
// Text
$_['text_approve_subject']      = '%s - Tài khoản liên kết của bạn đã được kích hoạt!';
...
$_['text_approve_services']     = 'Sau khi đăng nhập, bạn sẽ có thể tạo ra các mã số theo dõi, thanh toán hoa hồng theo dõi và chỉnh sửa thông tin tài khoản của bạn.';
$_['text_approve_thanks']       = 'Cảm ơn,';
$_['text_transaction_subject']  = '%s - liên kết Ủy nhiệm';
