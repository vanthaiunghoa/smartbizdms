<?php
// Heading
$_['heading_title']          = 'Giải pháp'; 

// Text  
$_['text_success']           = 'Hoàn tất: Bạn đã sửa đổi các giải pháp!';
$_['text_plus']              = '+';
$_['text_minus']             = '-';
...
$_['entry_stock_status']     = 'Hết hàng:<br/><span class="help">Tình trạng hiện ra khi một giải pháp hết hàng</span>';
$_['entry_tax_class']        = 'Thuế suất:';
$_['entry_price']            = 'Giá:';
$_['entry_points']           = 'Điểm:<br/><span class="help">Số điểm cần thiết để mua mặt hàng này. Nếu bạn không \'muốn giải pháp này được mua với điểm để là 0.</span>';
...
$_['entry_tag']          	 = 'Nhãn giải pháp:<br /><span class="help">Ngăn cách bằng dấu phẩy</span>';
...
$_['error_permission']       = 'Cảnh báo: Bạn không được phép sửa đổi các giải pháp!';
$_['error_name']             = 'Tên giải pháp phải lớn hơn 3 và nhỏ hơn 255 ký tự!';
$_['error_description']      = 'Mô tả giải pháp phải lớn hơn 3 và nhỏ hơn 255 ký tự!';
$_['error_model']            = 'Tên giải pháp phải lớn hơn 3 và nhỏ hơn 64 ký tự!';
?>