<?php
// Heading
$_['heading_title']          = 'Dùng thử'; 

// Text  
$_['text_success']           = 'Hoàn tất: Bạn đã sửa đổi thông tin demo!';
$_['text_plus']              = '+';
$_['text_minus']             = '-';
...
$_['entry_stock_status']     = 'Hết hàng:<br/><span class="help">Tình trạng hiện ra khi một demo hết hàng</span>';
$_['entry_tax_class']        = 'Thuế suất:';
$_['entry_price']            = 'Giá:';
$_['entry_points']           = 'Điểm:<br/><span class="help">Số điểm cần thiết để mua mặt hàng này. Nếu bạn không \'muốn demo này được mua với điểm để là 0.</span>';
...
$_['entry_tag']          	 = 'Nhãn demo:<br /><span class="help">Ngăn cách bằng dấu phẩy</span>';
...
$_['error_permission']       = 'Cảnh báo: Bạn không được phép sửa đổi các demo!';
$_['error_name']             = 'Tên demo phải lớn hơn 3 và nhỏ hơn 255 ký tự!';
$_['error_description']      = 'Mô tả demo phải lớn hơn 3 và nhỏ hơn 255 ký tự!';
$_['error_model']            = 'Tên demo phải lớn hơn 3 và nhỏ hơn 64 ký tự!';
?>