...
class ModelCatalogProduct extends Model {
	...
	public function editProduct($product_id, $data) {
		...
		$this->db->query("UPDATE " . DB_PREFIX . "product_featured SET product_id = '" . $product_id . "' WHERE product_id = $product_id");
	...
	public function updateListProduct($data, $prdIds) {
		foreach($prdIds as $key=>$prdId) {
			$price = str_replace('.','',$data[$key]);
			$price = str_replace(',','.',$price);
			$sql = "UPDATE " . DB_PREFIX . "product SET price = '" . (float)$price . "' WHERE product_id = '" . (int)$prdId . "'";
			$this->db->query($sql);
		}
	}
