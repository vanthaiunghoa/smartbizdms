...
class ControllerSettingSetting extends Controller {
	...
	public function index() {
		...
		if (isset($this->request->post['config_introduction'])) {
			$this->data['config_introduction'] = $this->request->post['config_introduction'];
		} else {
			$this->data['config_introduction'] = $this->config->get('config_introduction');
		}
		...
		if (isset($this->request->post['config_layout'])) {
			$this->data['config_layout'] = $this->request->post['config_layout'];
		} else {
			$this->data['config_layout'] = $this->config->get('config_layout');
		}
