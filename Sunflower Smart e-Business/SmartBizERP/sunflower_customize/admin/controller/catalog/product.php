...
class ControllerCatalogProduct extends Controller {
	private $error = array(); 
  	...
  	public function updateList() {
    	...
    	$this->document->setTitle($this->language->get('heading_title'));
		//print_r($this->request->post['productId']);
		//print_r($this->request->post['price']);
		//die;
		$this->load->model('catalog/product');
		if (isset($this->request->post['price']) && $this->validateUpdateList()) {
			$this->model_catalog_product->updateListProduct($this->request->post['price'],$this->request->post['productId']);
  	...
  	private function getList() {				
		...
		$this->data['update_list'] = $this->url->link('catalog/product/updateList', 'token=' . $this->session->data['token'] . $url, 'SSL');	
		...
		$this->data['button_update_list'] = $this->language->get('button_update_list');
