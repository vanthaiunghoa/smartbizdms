...
class ControllerCommonHeader extends Controller {
	protected function index() {
		...
		$this->data['text_download_category'] = $this->language->get('text_download_category');
		...
		*/
		...
		$this->data['text_solution_group'] = $this->language->get('text_solution_group');
		$this->data['text_quick_link_group'] = $this->language->get('text_quick_link_group');
		$this->data['text_service_group'] = $this->language->get('text_service_group');
		$this->data['text_download_group'] = $this->language->get('text_download_group');
		
		$this->data['text_solution'] = $this->language->get('text_solution'); 
		$this->data['text_solution_detail'] = $this->language->get('text_solution_detail');
		$this->data['text_service'] = $this->language->get('text_service');
		$this->data['text_service_detail'] = $this->language->get('text_service_detail');
		$this->data['text_select_all'] = $this->language->get('text_select_all');
		$this->data['text_unselect_all'] = $this->language->get('text_unselect_all');
      	$this->data['text_news'] = $this->language->get('text_news');
      	$this->data['text_demo'] = $this->language->get('text_demo');
		$this->data['text_quick_link'] = $this->language->get('text_quick_link');
		$this->data['text_quick_link_category'] = $this->language->get('text_quick_link_category');
		...
		if (!$this->user->isLogged() || !isset($this->request->get['token']) || !isset($this->session->data['token']) || ($this->request->get['token'] != $this->session->data['token'])) {
			...
			$this->data['download_category'] = $this->url->link('catalog/download_category', 'token=' . $this->session->data['token'], 'SSL');
			...
			*/
			...
			$this->data['solution'] = $this->url->link('catalog/solution', 'token=' . $this->session->data['token'], 'SSL');
			$this->data['solution_detail'] = $this->url->link('catalog/solution_detail', 'token=' . $this->session->data['token'], 'SSL');
			$this->data['service'] = $this->url->link('catalog/service', 'token=' . $this->session->data['token'], 'SSL');
			$this->data['service_detail'] = $this->url->link('catalog/service_detail', 'token=' . $this->session->data['token'], 'SSL');
			$this->data['news'] = HTTPS_SERVER . 'index.php?route=catalog/news&token=' . $this->session->data['token'];
			$this->data['demo'] = HTTPS_SERVER . 'index.php?route=catalog/demo&token=' . $this->session->data['token'];
			$this->data['quick_link'] = HTTPS_SERVER . 'index.php?route=catalog/quick_link&token=' . $this->session->data['token'];
			$this->data['quick_link_category'] = HTTPS_SERVER . 'index.php?route=catalog/quick_link_category&token=' . $this->session->data['token'];
		}
