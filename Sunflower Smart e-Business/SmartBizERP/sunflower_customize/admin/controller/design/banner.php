...
class ControllerDesignBanner extends Controller {
	...
	private function getForm() {
		...
		if($this->data['position'] == 'right') {
			$this->data['selected_right'] = 'selected="selected"';
			$this->data['selected_top'] = '';
			$this->data['selected_bottom'] = '';
			$this->data['selected_left'] = '';
		} else if($this->data['position'] == 'bottom') {
			$this->data['selected_bottom'] = 'selected="selected"';
			$this->data['selected_top'] = '';
			$this->data['selected_right'] = '';
			$this->data['selected_left'] = '';
		} else if($this->data['position'] == 'left') {
			$this->data['selected_left'] = 'selected="selected"';
			$this->data['selected_top'] = '';
			$this->data['selected_right'] = '';
			$this->data['selected_bottom'] = '';
		} else {
			$this->data['selected_top'] = 'selected="selected"';
			$this->data['selected_right'] = '';
			$this->data['selected_bottom'] = '';
			$this->data['selected_left'] = '';
		}
