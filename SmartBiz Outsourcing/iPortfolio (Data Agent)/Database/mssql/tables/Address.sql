...
IF OBJECT_ID('dbo.Address', N'U') IS NULL
CREATE TABLE dbo.Address
( 
	Address_ID           IPID  NOT NULL ,
	Customer_ID          IPID  NOT NULL ,
	Address_Type         IPString  NULL ,
...
IF OBJECT_ID('Address', N'U') IS NOT NULL
	PRINT '<<Success: Table Address is created.>>';
ELSE
	PRINT '<<Fail: Table Address is not created.>>';
GO
