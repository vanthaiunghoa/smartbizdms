...
CP=$DIRNAME/SmartBizPOS.jar

CP=$CP:$DIRNAME/lib/jasperreports-3.7.1.jar
...
# more libraries
set CP=$CP:$DIRNAME/lib/glazedlists_java15.jar"
set CP=$CP:$DIRNAME/lib/l2fprod-common-sheet.jar"
set CP=$CP:$DIRNAME/lib/jide-oss-2.9.2.jar"
set CP=$CP:$DIRNAME/lib/ValidationAPI.jar"
set CP=$CP:$DIRNAME/lib/nbstubs.jar"
CP=$CP:$DIRNAME/lib/TableLayout-bin-jdk1.5.jar"
CP=$CP:$DIRNAME/lib/DJSwingSuite.jar.jar"
...
# start SmartBiz POS
java -cp $CP -Dswing.defaultlaf=javax.swing.plaf.metal.MetalLookAndFeel -Djava.library.path=$DIRNAME$LIBRARYPATH -Ddirname.path=$DIRNAME/ vn.smartbiz.pos.forms.StartPOS "$@"
