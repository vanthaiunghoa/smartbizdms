...
import net.sf.jasperreports.engine.JRException;
 public class Salecatalog extends javax.servlet.http.HttpServlet implements javax.servlet.Servlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		// exporting process
		 ...
		 if (parameters.containsKey("pdf")){
			  keyword="pdf";			
			  try {
				com.openJasperReport("salecatalog","salecatalog.jrxml",keyword,response,FromDay,ToDay);
			} catch (JRException e) {
